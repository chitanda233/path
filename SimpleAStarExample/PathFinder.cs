    ...
    public class PathFinder
    {
        ...
        private List<Node> GetAdjacentWalkableNodes(Node fromNode)
        {
           ...
           /* Random ran=new Random();
            ...
            IEnumerable<Point> nextLocations = GetAdjacentLocationsbyRandom(fromNode.Location,key);*/
...
//                new Point(fromLocation.X+1, fromLocation.Y-1),
        ...
        private static IEnumerable<Point> GetAdjacentLocationsbyRandom(Point fromLocation,int i)
        {
            switch (i)
            {
                case 1:
                    return new Point[] {new Point(fromLocation.X, fromLocation.Y + 1)};
                    
                case 2:
                    return new Point[] { new Point(fromLocation.X, fromLocation.Y + 1) };
                   
                case 3:
                    return new Point[] { new Point(fromLocation.X + 1, fromLocation.Y)};
                    ;
                case 4:
                    return new Point[] { new Point(fromLocation.X, fromLocation.Y - 1) };
                    ;
